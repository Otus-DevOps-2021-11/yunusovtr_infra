...
### что сделано
 - В результате выполнения методички настроили пайплайн для нескольких окружений
 - Задание со *: в результате работы пайплайна собираем образ приложение и запускаем его в докере.
