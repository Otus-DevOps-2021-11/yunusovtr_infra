...
### Что сделано
 ...
 - Ошибка линтёра при сдаче видимо связана с нежеланием ansible-lint обрабатывать относительные пути в опции --exclude, из-за чего роль jdauphant.nginx всё-таки проверяется, а в ней ошибка - роль имеет повторяющийся when в одном из тасков. Надо б исправить в тестах!!!
